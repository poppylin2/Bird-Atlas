...
st.set_page_config(page_title="Bird Atlas") 
...
st.sidebar.title('🐦Welcome to Bird Atlas')
st.sidebar.write('''
...
st.sidebar.write(
    ...
    <div style="text-align: center; margin-top: 50px; padding-bottom: 50px;">
        <a href="https://github.com/poppylin2/Bird-Atlas"><strong>Learn more</strong></a> about this website and the underlying machine learning model.
